---
layout: post
title: "Making Voice Assistants to Serve Your Needs"
...
![Making voice assistants to serve your needs](/images/voice_assistants/cover_voice_assistant.jpg)
...
![Amazon's voice assistant Alexa](/images/voice_assistants/DSC_0234.jpg)
...
![Amazon's voice assistant Alexa](/images/voice_assistants/DSC_0236.jpg)
...
![Amazon's voice assistant Alexa](/images/voice_assistants/DSC_0246-1.jpg)

You can also, for example, put your voice assistant in your lobby or reception area. Just like a greeter robot welcomes guests, the voice assistant can answer any questions that your guests might have.
...
![Amazon's voice assistant Alexa](/images/voice_assistants/DSC_0232.jpg)

## How Alexa works

Want to see how it works? I made a short video to show how I connected my device to a local database. I have a web interface, which I can access via a tablet, that can represent any company's website. Alexa is able to access all the website's information without needing to open different pages, input search queries or filters by hand or spend time on calculations. [Watch the demo on YouTube.](https://www.youtube.com/watch?v=KwUvftfmBUs&t=6s)
...
*Continued in [Enhance Your Business Functions Using Alexa on Ruby]({% post_url 2018-09-21-enhance-your-business-functions-using-alexa-on-ruby %}), where I walk through the implementation.*
